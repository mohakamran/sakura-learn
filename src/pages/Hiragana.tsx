...
import { hiraganaData, Character } from '../data/hiragana';
  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-4xl font-serif font-bold text-slate-800 dark:text-white mb-2">Hiragana</h1>
          <p className="text-slate-600 dark:text-slate-300">The basic phonetic script of Japanese.</p>
        </div>
